...
class XRPSustainabilitySpider(scrapy.Spider):
    name = 'xrp_sustainability_spider'
    allowed_domains = ['xrpl.org', 'xrpl-commons.org']
    start_urls = [
    ...
    def __init__(self, *args, **kwargs):
        super(XRPSustainabilitySpider, self).__init__(*args, **kwargs)
    ...
    def parse(self, response):
        ...
        yield {
            'company': 'XRP',  # Set company name to XRP
            'network': 'xrp',
            'text': combined_text,
            'sustainability_info': {
                'headings': headings,
