...
class chainlinkSustainabilitySpider(scrapy.Spider):
    name = 'chainlink_sustainability_spider'
    start_urls = [
        'https://chain.link/use-cases/climate-markets',
    ...
    def __init__(self, *args, **kwargs):
        super(chainlinkSustainabilitySpider, self).__init__(*args, **kwargs)
